...
Deletes a saved career from the Supabase database by ID.
...
- **Save Button:** Save Button doesn't prevent double clicks — clicking "Save Career" twice quickly saves the same job twice with no warning
